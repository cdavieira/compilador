...
inoremap <silent> <SNR>88_AutoPairsReturn =AutoPairsReturn()
...
imap <expr> <C-J> vsnip#expandable()  ? '<Plug>(vsnip-expand)'         : '<NL>'
tnoremap  
snoremap <expr> 	 vsnip#jumpable(1)   ? '<Plug>(vsnip-jump-next)'      : '	'
smap <expr>  vsnip#available(1)  ? '<Plug>(vsnip-expand-or-jump)' : ''
nnoremap  o <Cmd>Ollama toggle
nnoremap  s <Cmd>Rg
nnoremap  r <Cmd>source $MYVIMRC
nnoremap  p <Cmd>edit $MYVIM_FILES
nnoremap  f <Cmd>Files
nnoremap  e <Cmd>NERDTreeToggle
nnoremap  v <ScriptCmd>colorschemes.Rotate(+1)
nnoremap  c <ScriptCmd>colorschemes.Rotate(-1)
nnoremap  b <Cmd>Buffers
map Q gq
...
imap s <Plug>Isurround
inoremap <expr> 	 vsnip#jumpable(1)   ? '<Plug>(vsnip-jump-next)'      : '	'
imap <expr> <NL> vsnip#expandable()  ? '<Plug>(vsnip-expand)'         : '<NL>'
imap <expr>  vsnip#available(1)  ? '<Plug>(vsnip-expand-or-jump)' : ''
imap  <Plug>Isurround
let &cpo=s:cpo_save
unlet s:cpo_save
set autoindent
...
set laststatus=2
set nomodeline
set operatorfunc=<SNR>85_go
set packpath=~/.config/vim,/usr/share/vim/vim91,~/.config/vim/after
set ruler
set runtimepath=~/.config/vim,~/.config/vim//vim-plug/dracula,~/.config/vim//vim-plug/onedark.vim,~/.config/vim//vim-plug/catppuccin,~/.config/vim//vim-plug/nerdtree,~/.config/vim//vim-plug/vim-devicons,~/.config/vim//vim-plug/fzf,~/.config/vim//vim-plug/fzf.vim,~/.config/vim//vim-plug/vim-lsp,~/.config/vim//vim-plug/asyncomplete.vim,~/.config/vim//vim-plug/asyncomplete-lsp.vim,~/.config/vim//vim-plug/vim-vsnip,~/.config/vim//vim-plug/vim-vsnip-integ,~/.config/vim//vim-plug/friendly-snippets,~/.config/vim//vim-plug/vim-commentary,~/.config/vim//vim-plug/vim-surround,~/.config/vim//vim-plug/vim-endwise,~/.config/vim//vim-plug/auto-pairs,~/.config/vim//vim-plug/vim-fugitive,~/.config/vim//vim-plug/tagbar,~/.config/vim//vim-plug/tabular,~/.config/vim//vim-plug/vim-markdown,~/.config/vim//vim-plug/vim-markdown-toc,~/.config/vim//vim-plug/vim-closetag,~/.config/vim//vim-plug/vim-css-color,~/.config/vim//vim-plug/vim-javascript,~/.config/vim//vim-plug/yats.vim,~/.config/vim//vim-plug/vim-jsx,~/.config/vim//vim-plug/vim-solidity,~/.config/vim//vim-plug/vscode-solidity,~/.config/vim//vim-plug/vim-airline,~/.config/vim//vim-plug/vim-airline-themes,~/.config/vim//vim-plug/vim-startify,~/.config/vim//vim-plug/vim-cool,/usr/share/vim/vim91,/usr/share/vim/vim91/pack/dist/opt/editorconfig,~/.config/vim//vim-plug/catppuccin/after,~/.config/vim//vim-plug/vim-vsnip-integ/after,~/.config/vim//vim-plug/tabular/after,~/.config/vim//vim-plug/vim-markdown/after,~/.config/vim//vim-plug/vim-css-color/after,~/.config/vim//vim-plug/vim-javascript/after,~/.config/vim//vim-plug/vim-jsx/after,~/.config/vim/after
set shell=/bin/bash
set shiftwidth=2
...
badd +602 parser/parser.y
badd +5 ezlang/src/Literal.c
badd +4 lib/type/Literal.h
badd +3 lib/type/Variable.h
badd +86 lib/type/Type.h
badd +1 lib/type/Value.h
badd +13 lexer/lexer.l
badd +1 src/lexer.yy.c
badd +5 src/management/VarTable.c
badd +1 src/type/Literal.c
badd +5 src/type/Variable.c
badd +2 src/type/Scope.c
badd +3 lib/type/Scope.h
badd +1 lib/type/Function.h
badd +44 src/type/Type.c
badd +1 src/type/Function.c
badd +10 src/management/AST.c
badd +77 lib/management/AST.h
badd +3 lib/management/ScopeManager.h
badd +1 src/management/ScopeManager.c
badd +4 lib/management/VarTable.h
badd +3 lib/management/FuncTable.h
badd +3 src/management/FuncTable.c
badd +1 lib/lexer.yy.h
badd +37 README.md
badd +77 ezlang/lib/ast.h
badd +542 ezlang/parser/parser.y
argglobal
%argdel
$argadd parser/parser.y
set stal=2
tabnew +setlocal\ bufhidden=wipe
tabnew +setlocal\ bufhidden=wipe
tabrewind
edit lib/management/AST.h
...
inoremap <buffer> <silent> <M-)> =AutoPairsMoveCharacter(')')
inoremap <buffer> <silent> <M-(> =AutoPairsMoveCharacter('(')
nnoremap <buffer>  j <Plug>(lsp-rename)
nnoremap <buffer>  l <Plug>(lsp-preview-close)
nnoremap <buffer>  w <Plug>(lsp-preview-focus)
nnoremap <buffer>  i <Plug>(lsp-document-diagnostics)
nnoremap <buffer>  m <Plug>(lsp-document-symbol)
nnoremap <buffer>  k <Plug>(lsp-hover)
nnoremap <buffer>  h <Plug>(lsp-type-hierarchy)
nnoremap <buffer>  t <Plug>(lsp-type-definition)
nnoremap <buffer>  g <Plug>(lsp-implementation)
nnoremap <buffer>  d <Plug>(lsp-definition)
nnoremap <buffer>  a <Plug>(lsp-declaration)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 21 - ((14 * winheight(0) + 17) / 34)
...
wincmd w
argglobal
if bufexists(fnamemodify("src/management/AST.c", ":p")) | buffer src/management/AST.c | else | edit src/management/AST.c | endif
balt lib/management/AST.h
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
inoremap <buffer> <silent> <expr> <M-p> AutoPairsToggle()
...
silent! normal! zE
let &fdl = &fdl
let s:l = 89 - ((20 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 89
...
silent! normal! zE
let &fdl = &fdl
let s:l = 717 - ((20 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 717
...
wincmd w
argglobal
if bufexists(fnamemodify("lib/type/Literal.h", ":p")) | buffer lib/type/Literal.h | else | edit lib/type/Literal.h | endif
balt ezlang/lib/ast.h
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
...
wincmd w
argglobal
if bufexists(fnamemodify("ezlang/lib/ast.h", ":p")) | buffer ezlang/lib/ast.h | else | edit ezlang/lib/ast.h | endif
balt ezlang/parser/parser.y
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
inoremap <buffer> <silent> <expr> <M-p> AutoPairsToggle()
...
silent! normal! zE
let &fdl = &fdl
let s:l = 77 - ((15 * winheight(0) + 8) / 16)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 77
...
wincmd w
argglobal
if bufexists(fnamemodify("src/type/Literal.c", ":p")) | buffer src/type/Literal.c | else | edit src/type/Literal.c | endif
balt src/type/Type.c
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
