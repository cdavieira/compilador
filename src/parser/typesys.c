...
static const TypeData logical_table_lookup[][4] = {
	{{TYPE_VOID,}, {TYPE_VOID,}, {TYPE_VOID,}, {TYPE_VOID,}},
	{{TYPE_VOID,}, {TYPE_INT,CONV_NONE,CONV_NONE}, {TYPE_INT,CONV_I2F,CONV_NONE},  {TYPE_INT,CONV_NONE,CONV_C2I}},
	{{TYPE_VOID,}, {TYPE_INT,CONV_NONE,CONV_I2F},  {TYPE_INT,CONV_NONE,CONV_NONE}, {TYPE_INT,CONV_NONE,CONV_C2F}},
	{{TYPE_VOID,}, {TYPE_INT,CONV_C2I,CONV_NONE},  {TYPE_INT,CONV_C2F,CONV_NONE},  {TYPE_INT,CONV_C2I,CONV_C2I}},
};

static const TypeData assign_table_lookup[][4] = {
	{{TYPE_VOID,}, {TYPE_VOID,}, {TYPE_VOID,}, {TYPE_VOID,}},
	{{TYPE_VOID,}, {TYPE_INT,CONV_NONE,CONV_NONE}, {TYPE_INT,CONV_NONE,CONV_F2I},  {TYPE_INT,CONV_NONE,CONV_C2I}},
	{{TYPE_VOID,}, {TYPE_FLT,CONV_NONE,CONV_I2F},  {TYPE_FLT,CONV_NONE,CONV_NONE}, {TYPE_FLT,CONV_NONE,CONV_C2F}},
	{{TYPE_VOID,}, {TYPE_CHAR,CONV_NONE,CONV_I2C}, {TYPE_CHAR,CONV_NONE,CONV_F2C},  {TYPE_CHAR,CONV_NONE,CONV_NONE}},
}; 
